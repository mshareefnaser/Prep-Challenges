...
const getInfo = (arr) => {
  ...
  for (const object of arr) {
    for (const key in object) {
      if (Object.hasOwnProperty(object, "course")) {
        coursesName.push(object[key]);
      }
      else if (Object.hasOwnProperty(object, "Students")) {
        studentsName.push(object[key]);
      }
    }
