...
const objectCounter = (obj) => {
    ...
    const counter = obj.reduce((acc) => acc + 1, 0)
    return counter;
}
// -------------------------------------------------------------------------------------------------------
...
const stringReverse = (str) => {
    ...
    const reversed = splited.reduce((acc, val, idx) =>{acc.unshift(val); return acc;} , [])
    let result = reversed.reduce((acc,val)=>acc+" "+val,"")
